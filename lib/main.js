...
module.exports = {
  ...
  consumeStatusBar(statusBar) {
    ...
    const observedFilesStatusTile = this.observedFilesStatusTile;
    return new Disposable(() => {
      statusBarTile.destroy();
      observedFilesStatusTile.destroy();
      if (this.statusBarTile === statusBarTile) this.statusBarTile = null;
      if (this.observedFilesStatusTile === observedFilesStatusTile) {
        this.observedFilesStatusTile = null;
      }
    });
  },
