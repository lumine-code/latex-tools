...
module.exports = {
  ...
  openPdf() {
    ...
    if (!editor) {
      lumine.notifications.addWarning("No active editor");
      return;
    }
  ...
  toggleCompileOnSave() {
    ...
    if (enabled) {
      ...
      lumine.notifications.addInfo(`Compile on save disabled for ${fileName}`);
      ...
      lumine.notifications.addSuccess(`Compile on save enabled for ${fileName}`);
